...
.webix_window {
  position: absolute;
  box-shadow: 0 1px 7px 1px #818181;
}
.webix_window:focus {
  box-shadow: 0 1px 12px 1px #818181;
}
.webix_win_body {
  overflow: hidden;
}
...
.webix_point_right,
.webix_point_left {
  background-image: url("data:image/png;base64,");
}
.webix_point_top {
...
.webix_shadow_small {
  box-shadow: 0 1px 3px 1px #818181;
}
.webix_shadow_big {
  box-shadow: 0 1px 12px 1px #818181;
}
...
.webix_dtable .webix_hcell .webix_excel_filter:hover {
  color: #e2e2a7;
}
.webix_dtable .webix_hcell.webix_ss_filter_active .webix_excel_filter {
  color: #e2e2a7;
}
.webix_dtable .webix_hcell.webix_ss_filter_active .webix_excel_filter:hover {
  color: #cfcf6d;
}
.webix_ss_sort_asc,
.webix_ss_sort_desc {
...
.webix_menu-x.webix_disabled_view .webix_list_item {
...
.webix_item_tab.webix_selectedhover,
...
.webix_cal_month_namehover,
.webix_cal_timehover,
.webix_cal_prev_buttonhover,
.webix_cal_next_buttonhover,
.webix_cal_month_name:focus,
.webix_cal_time:focus,
...
.webix_menu.webix_sidebar_popup_list .webix_sidebar_selected,
.webix_menu.webix_sidebar_popup_list .webix_selected {
  background: #1F884C;
}
.webix_menu.webix_sidebar_popup_list .webix_sidebar_selected:hover,
.webix_menu.webix_sidebar_popup_list .webix_selected:hover {
  background: #1F884C !important;
}
.webix_menu.webix_sidebar_popup_list .webix_list_item {
  border-color: #393939;
}
.webix_menu.webix_sidebar_popup_list .webix_list_item:focus {
  color: #fff;
}
.webix_sidebar_popup_title {
  background-color: #191919;
