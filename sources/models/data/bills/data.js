...
const bills_stats = new webix.DataCollection({
  id: "bills_stats",
  url: function (params) {
    return ServerController.getData("bills", "getStat", "vue1");
  },
});
...
const bills_bill_mk_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("bills", "getBilling", "fact", "bill_mark");
  },
});
...
const bills_off_split = new webix.DataCollection({
  id: "bills_off_split",
  url: function (params) {
    return ServerController.getData("bills", "getBilling", "fact", "offer");
  },
});
...
const pays_bill_mk_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("bills", "getBilling", "pay", "bill_mark");
  },
});
...
const pays_off_split = new webix.DataCollection({
  id: "pays_off_split",
  url: function (params) {
    return ServerController.getData("bills", "getBilling", "pay", "offer");
  },
});
...
const recouvr_off_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("bills", "getRecouvr", "split");
  },
});
...
const recouvr_trend = new webix.DataCollection({
  id: "recouvr_trend",
  url: function (params) {
    return ServerController.getData("bills", "getRecouvr", "trend");
  },
});
...
//prod_trend_tab
const recouvr_prod_tab = new webix.DataCollection({
  id: "recouvr_prod_tab",
  url: function (params) {
    return ServerController.getData("bills", "getRecouvr", "prod_trend_tab");
  },
});
...
const bills_by_type_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("bills", "getSplit", "bill", "type");
  },
});
...
const bills_by_status_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("bills", "getSplit", "bill", "status");
  },
});
...
const pay_by_type_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("bills", "getSplit", "pay", "type");
  },
});
...
const pay_by_status_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("bills", "getSplit", "pay", "status");
  },
});
...
const bill_by_zone = new webix.DataCollection({
  id: "bill_by_zone",
  url: function (params) {
    return ServerController.getData("bills", "getBillZone", "vue1");
  },
});
...
const bill_by_zone_exp = new webix.DataCollection({
  id: "bill_by_zone_exp",
  url: function (params) {
    return ServerController.getData("bills", "getBillZone", "vue2");
  },
});
...
const bill_by_lib = new webix.DataCollection({
  id: "bill_by_lib",
  url: function (params) {
    return ServerController.getData("bills", "getBillLib", "vue1");
  },
});
...
const bill_by_lib_exp = new webix.DataCollection({
  id: "bill_by_lib_exp",
  url: function (params) {
    return ServerController.getData("bills", "getBillLib", "vue2");
  },
});
...
const agent_pay = new webix.TreeCollection({
  id: "agent_pay",
  url: function (params) {
    return ServerController.getData("bills", "getEncaiss", "vue1");
  },
});
...
const agent_pay_exp = new webix.DataCollection({
  id: "agent_pay_exp",
  url: function (params) {
    return ServerController.getData("bills", "getEncaiss", "vue10");
  },
});
...
const pay_by_method = new webix.DataCollection({
  id: "pay_by_method",
  url: function (params) {
    return ServerController.getData("bills", "getEncaiss", "meth");
  },
});
...
function getAllBillsData() {
  return [
    ...
    {
      type: "fact",
      data: bills_bill_mk_split,
      func: "getBilling",
      params: "bill_mark",
    },
    {
      type: "fact",
      data: bills_off_split,
      func: "getBilling",
      params: "offer",
    },
    {
      type: "fact",
      data: bills_off_trend,
      func: "getBilling",
      params: "month_trend",
    },
    ...
    { type: "prod_trend_tab", data: recouvr_prod_tab, func: "getRecouvr" },
    {
      type: "bill",
