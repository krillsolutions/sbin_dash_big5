...
const traffic_stat = new webix.DataCollection({
        id : 'traffic_stat',
        url :  function(params) { return ServerController.getData('traffic', 'getStat', 'stat')}
});
/*
...
const int_traffic_geo = new webix.DataCollection({
        id : 'int_traffic_geo',
        url :  function(params) { return ServerController.getData('traffic', 'getTrafficIntGeo', 'vue1', 'all')}
});

const int_traffic_geo_sample = new webix.DataCollection({
        id : 'int_traffic_geo_sample',
        url :  function(params) { return ServerController.getData('traffic', 'getTrafficIntGeo', 'vue2', 'all')}
});
...
const traffic_split = new webix.DataCollection({
        id : 'traffic_split',
        url :  function(params) { return ServerController.getData('traffic', 'getTrafficSplit', 'vue1')}
});

const traffic_dest_split = new webix.DataCollection({
        id : 'traffic_dest_split',
        url :  function(params) { return ServerController.getData('traffic', 'getTrafficByDest', 'vue1')}
});

const traffic_offer_split = new webix.DataCollection({
        id : 'traffic_offer_split',
        url :  function(params) { return ServerController.getData('traffic', 'getTrafficByOff', 'vue1')}
});

const traffic_offer_split_exp = new webix.DataCollection({
        id : 'traffic_offer_split_exp',
        url :  function(params) { return ServerController.getData('traffic', 'getTrafficByOff', 'vue2')}
});


const traffic_operator_split = new webix.DataCollection({
        id : 'traffic_operator_split',
        url :  function(params) { return ServerController.getData('traffic', 'getTraffByOpType', 'vue1')}
});
/*
...
const traffic_data_parc= new webix.DataCollection({
        ...
        url :  function(params) { return ServerController.getData('traffic', 'getTraffDataParc', 'vue1')}
});

//
const traffic_data_type_trend= new webix.DataCollection({
        id : 'traffic_data_type_trend',
        url :  function(params) { return ServerController.getData('traffic', 'getTraffDataType', 'vue1')}
});

const traffic_data_type_split= new webix.DataCollection({
        id : 'traffic_data_type_split',
        url :  function(params) { return ServerController.getData('traffic', 'getTraffDataType', 'split')}
});


const traffic_data_site_split= new webix.DataCollection({
        id : 'traffic_data_site_split',
        url :  function(params) { return ServerController.getData('traffic', 'getTraffDataBySite', 'vue1')}
});
...
export function getAllRevData() {
	    ...
	    {type :'vue1', data : data_traffic_geo, func : 'getTrafficGeo', params : 'data'},*/
            {type : 'vue1', data : int_traffic_geo, func : 'getTrafficIntGeo', params : 'all' },
	    {type : 'vue2', data : int_traffic_geo_sample, func : 'getTrafficIntGeo', params : 'all' },
...
export const functions_ref = {
        'stat' : 'getStat', 'nat_traffic' : 'getTrafficGeo', 'int_traffic' : 'getTrafficIntGeo', 'traffic_type' : 'getTrafficSplit', 'traffic_dest' : 'getTrafficByDest',
        'traffic_offer' : 'getTrafficByOff', 'traffic_operator' : 'getTraffByOpType', 'traffic_data_bill' : 'getTraffDataBill', 'parc_data' : 'getTraffDataParc',
        'data_type' : 'getTraffDataType'
}   

export function getFiterDate(func, type, date, params){

                return ServerController.getDrillData('traffic',functions_ref[func], type, date, params);
