...
new SalesServerManager(host);

const sales_stats = new webix.DataCollection({
  id: "sales_stats",
  url: function (params) {
    return ServerController.getData("sales", "getStat", "vue1");
  },
});
...
const sales_cat_split = new webix.DataCollection({
  id: "sales_cat_split",
  url: function (params) {
    return ServerController.getData("sales", "getSales", "split");
  },
});
...
const sales_cat_trend = new webix.DataCollection({
  id: "sales_cat_trend",
  url: function (params) {
    return ServerController.getData("sales", "getSales", "month_trend");
  },
});
...
const sales_cat_prod_split = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("sales", "getSaleSplit", "vue1");
  },
});
...
const sales_pop_user_prod = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("sales", "getSaleSplit", "pop1");
  },
});
...
function getAllSalesData() {
  return [
    ...
    {
      type: "tot",
      data: sales_tot_trend,
      func: "getSalesTrend",
      params: "month_trend",
    },
    {
      type: "users",
      data: sales_user_split_trend,
      func: "getSalesTrend",
      params: "month_trend",
    },
    {
      type: "pops",
      data: sales_pop_split_trend,
      func: "getSalesTrend",
      params: "month_trend",
    },
...
export const functions_ref = {
  stat: "getStat",
  product: "getProduct",
  client: "getSaleClientType",
  proditem: "getProductItem",
  sales: "getSalesTrend",
  split_trend: "getSales",
};
