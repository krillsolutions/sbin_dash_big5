...
const parc_home_stat = new webix.DataCollection({
  id: "parc_home_stat",
  url: function (params) {
    return ServerController.getData("home", "getStat", "parc");
  }, //getDUrl('home', 'getStat', 'parc')
...
const rev_home_stat = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("home", "getStat", "revenue");
  },
});
...
const tvoix_home_stat = new webix.DataCollection({
  id: "tvoix_home_stat",
  url: function (params) {
    return ServerController.getData("home", "getStat", "tvoix");
  },
});
...
const tdata_home_stat = new webix.DataCollection({
  id: "tdata_home_stat",
  url: function (params) {
    return ServerController.getData("home", "getStat", "tdata");
  },
});
...
const topup_home_stat = new webix.DataCollection({
  id: "topup_home_stat",
  url: function (params) {
    return ServerController.getData("home", "getStat", "topup");
  },
});
...
const encaiss_home_stat = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("home", "getStat", "encaiss");
  },
});
...
const parc_bill = new webix.DataCollection({
  id: "parc_bill",
  url: function (params) {
    return ServerController.getData("home", "getParc", "bill");
  },
});
...
const parc_trend = new webix.DataCollection({
  id: "parc_trend",
  url: function (params) {
    return ServerController.getData("home", "getParc", "month_trend");
  },
});
...
const rev_trend_home = new webix.DataCollection({
  id: "rev_trend_home",
  url: function (params) {
    return ServerController.getData("home", "getRevenue", "vue1");
  },
});
...
const data_bill_home = new webix.DataCollection({
  id: "data_bill_home",
  url: function (params) {
    return ServerController.getData("home", "getData", "bill");
  },
});
...
const data_trend_home = new webix.DataCollection({
  id: "data_trend_home",
  url: function (params) {
    return ServerController.getData("home", "getData", "month_trend");
  },
});
...
const recharge_split_home = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("home", "getRecharge", "split");
  },
});
...
const recharge_trend_home = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("home", "getRecharge", "month_trend");
  },
});
...
const home_parc_by_prod = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("home", "getParc", "prod");
  },
});
...
const arpu_trend_home = new webix.DataCollection({
  id: "arpu_trend_home",
  url: function (params) {
    return ServerController.getData("home", "getArpu", "month_trend");
  },
});
...
const traffic_trend_home = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("home", "getTrafficSplitAll", "vue1");
  },
});
...
const trend_pay = new webix.DataCollection({
  id: "trend_pay",
  url: function (params) {
    return ServerController.getData("home", "getPay", "month_trend");
  },
});
...
export function getAllHomeData() {
  return [
    ...
    {
      type: "tvoix",
      data: tvoix_home_stat,
      id: "tvoix_home_stat",
      func: "getStat",
    },
    {
      type: "tdata",
      data: tdata_home_stat,
      id: "tdata_home_stat",
      func: "getStat",
    },
    {
      type: "topup",
      data: topup_home_stat,
      id: "topup_home_stat",
      func: "getStat",
    },
    ...
    {
      type: "month_trend",
      data: data_trend_home,
      id: "data_trend_home",
      func: "getData",
    },
    {
      type: "split",
      data: recharge_split_home,
      id: "recharge_split_home",
      func: "getRecharge",
    },
    {
      type: "month_trend",
      data: recharge_trend_home,
      id: "recharge_trend_home",
      func: "getRecharge",
    },
    ...
    {
      type: "month_trend",
      data: arpu_trend_home,
      id: "arpu_trend_home",
      func: "getArpu",
    },
    {
      type: "vue1",
      data: traffic_trend_home,
      id: "traffic_trend_home",
      func: "getTrafficSplitAll",
    },
