...
const parc_stat = new webix.DataCollection({
        id : 'parc_stat',
        url :  function(params) { return ServerController.getData('parc', 'getStat', 'vue1')}
});
const parc_billing = new webix.DataCollection({
    id : 'parc_billing',
    url :  function(params) { return ServerController.getData('parc', 'getParcByBill', 'vue1')}
});
/*
...
const parc_off_grp = new webix.DataCollection({
    id : 'parc_off_grp',
    url :  function(params) { return ServerController.getData('parc', 'getParcByOffer', 'vue3')}
});

const parc_off_grp_exp = new webix.DataCollection({
    id : 'parc_off_grp_exp',
    url :  function(params) { return ServerController.getData('parc', 'getParcByOffer', 'vue4')}
});


const parc_bill_mark_prod = new webix.TreeCollection({
    id : 'parc_bill_mark_prod',
    url :  function(params) { return ServerController.getData('parc', 'getParcByOffer', 'vue5')}
});

const parc_bill_mark_prod_exp = new webix.DataCollection({
    id : 'parc_bill_mark_prod_exp',
    url :  function(params) { return ServerController.getData('parc', 'getParcByOffer', 'vue6')}
});

const parc_by_prod = new webix.DataCollection({
    id : 'parc_by_prod',
    url :  function(params) { return ServerController.getData('parc', 'getParcByType', 'split')}
});
...
const parc_by_prod_trend = new webix.DataCollection({
    ...
    url :  function(params) { return ServerController.getData('parc', 'getParcByType', 'month_trend')}
});

const parc_by_status_by_net = new webix.DataCollection({
    id : 'parc_by_status_by_net',
    url : function(params) { return ServerController.getData('parc', 'getParcByStatus', 'split')}
})

const parc_by_status_by_net_exp = new webix.DataCollection({
    id : 'parc_by_status_by_net_exp',
    url : function(params) { return ServerController.getData('parc', 'getParcByStatus', 'exp')}
})
...
export const functions_ref = {
        'stat' : 'getStat', 'geo' : 'getParcGeo', 'type' : 'getParcByType', 'operator' : 'getOpSplit', 'markType' : 'getParcByType', 'markTypeExp' : 'getParcByType', 'in_statut' : "getINSplit","line" : 'getParcLine'
}   

export function getFiterDate(func, type, date,params){

                return ServerController.getDrillData('parc',functions_ref[func], type, date,params);
