...
const monitor_stats = new webix.DataCollection({
        id : 'monitor_stats',
        url :  function(params) { return ServerController.getData('monitor', 'getStat', 'vue1')}
});

const monitor_tab = new webix.DataCollection({
    id : 'monitor_tab',
    url :  function(params) { return ServerController.getData('monitor', 'getMonTab', 'vue1')}
});

const monitor_line = new webix.DataCollection({
    id : 'monitor_line',
    url :  function(params) { return ServerController.getData('monitor', 'getMonLine', 'vue1')}
});
/*
