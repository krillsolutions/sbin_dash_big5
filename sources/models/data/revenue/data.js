...
const rev_net_split = new webix.DataCollection({
  id: "rev_net_split",
  url: function (params) {
    return ServerController.getData("revenue", "getRevTypeByNet", "vue1");
  },
});
...
const rev_net_split_exp = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("revenue", "getRevTypeByNet", "vue2");
  },
});
...
const rev_type_prod_split = new webix.TreeCollection({
  ...
  url: function (params) {
    return ServerController.getData("revenue", "getRevTypeByProd", "vue1");
  },
});
...
const rev_type_prod_split_exp = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("revenue", "getRevTypeByProd", "vue2");
  },
});
...
const rev_line_split = new webix.DataCollection({
  id: "rev_line_split",
  url: function (params) {
    return ServerController.getData("revenue", "getRevLine", "split", "vue1");
  },
});
...
const rev_line_trend = new webix.DataCollection({
  id: "rev_line_trend",
  url: function (params) {
    return ServerController.getData("revenue", "getRevLine", "month_trend");
  },
});
...
const rev_clt_split = new webix.DataCollection({
  id: "rev_clt_split",
  url: function (params) {
    return ServerController.getData("revenue", "getRevTypeClt", "vue1");
  },
});
...
const rev_clt_split_exp = new webix.DataCollection({
  ...
  url: function (params) {
    return ServerController.getData("revenue", "getRevTypeClt", "vue2");
  },
});
...
export function getAllRevData() {
  return [
    ...
    { type: "split", data: rev_split, func: "getRevenue" },
    {
      type: "vue1",
      data: rev_net_split,
      func: "getRevTypeByNet",
      params: "vue1",
    },
    {
      type: "vue2",
      data: rev_net_split_exp,
      func: "getRevTypeByNet",
      params: "vue2",
    },
    {
      type: "vue1",
      data: rev_type_prod_split,
      func: "getRevTypeByProd",
      params: "vue1",
    },
    {
      type: "vue2",
      data: rev_type_prod_split_exp,
      func: "getRevTypeByProd",
      params: "vue2",
    },
    ...
    {
      type: "vue2",
      data: rev_clt_split_exp,
      func: "getRevTypeClt",
      params: "vue2",
    },
    {
      type: "month_trend",
      data: rev_trend_split,
      func: "getRevenue",
      params: "vue2",
    },
