...
const rev_type_split = new webix.DataCollection({
    id : 'rev_type_split',
    url :  function(params) { return ServerController.getData('revenue', 'getRevenue', 'vue0')}
});

const rev_trend_split = new webix.DataCollection({
    id : 'rev_trend_split',
    url :  function(params) { return ServerController.getData('revenue', 'getRevenue', 'vue1', 'vue1')}
});
...
export const functions_ref = {
        'stat' : 'getStat', 'split_trend' : 'getRevenue', 'operators' : 'getRevByOpType', 'bndle' : 'getRevByBundleType', 'rev_geo' : 'getRevGeo', 'operators_traff' : 'getRevByOpType',
	'traf_roam' : 'getRoaming', 'rev_roam' : 'getRoaming'
}   
