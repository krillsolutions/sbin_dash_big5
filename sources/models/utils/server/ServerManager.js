    ...
    return $.when(
      $.ajax({
        ...
        if (res.data && res["data"].length != 0) {
          ...
          data.data[0]["var"] =
            k2 > 0 ? ((100 * res["data"][0]["kpi_var"]) / k2).toFixed(2) : 100;
        }
      })
      /*$.ajax({
            method : 'GET',
            ...
            res.data.forEach((elm) => {
              for (let rt in rev_type) {
                if (elm[rt] > 0)
                  data["data"].push({
                    rev_type: rt,
                    revenue: Number.parseFloat(elm[rt]),
                    _type: "rev_split",
                  });
              }
            });
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.data_traff > 0)
                data["data"].push({
                  bill_tpe: elm.bill_tpe,
                  traffic: elm.data_traff,
                  category: "data",
                });
            });
          })
          ...
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.parc > 0)
                data["data"].push({
                  month: elm.month,
                  trend: Number.parseFloat(elm.rev) / Number.parseInt(elm.parc),
                  _type: "month_trend",
                });
            });
          })
            ...
            res.data.forEach((elm) => {
              if (elm.parc > 0)
                data["data"].push({
                  upd_dt: elm.upd_dt,
                  trend_dt:
                    Number.parseFloat(elm.rev) / Number.parseInt(elm.parc),
                  _type: "dt_trend",
                  period: elm.upd_dt.substr(0, 7),
                });
            });
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              data["data"].push({
                month: elm.month,
                revenue: Number.parseInt(elm.kpi),
                _type: "month_trend",
                _kpi: elm.billing_type,
                clt_type: elm.billing_type,
              });
            });
          })
        ).then(function () {
...
export class ParcServerManager {
  constructor(url) {
    ...
    // console.log(ParcServerManager.api_url);
  }
      ...
      case "vue1":
        ...
        return $.when(
          $.ajax({
            ...
            data.data = getHierachy(
              res.data,
              ["net", "bill", "mark", "seg", "cat", "off"],
              "kpi"
            );
          })
        ).then(function () {
      ...
      case "vue5":
        ...
        return $.when(
          $.ajax({
            ...
            data.data = getTreeHierachy(
              res.data,
              ["bill", "mark", "cat", "seg", "prod"],
              "parc",
              ["qty"]
            ).map((d) => ({ ...d, open: true }));
          })
  ...
  static getStat(type, filters) {
    ...
    return $.when(
      $.ajax({
        ...
        data["data"].push({
          kpi: "rpyg",
          value: res["data"][0]["pyg"],
          var:
            res["data"][0]["pyg_12"] != 0 &&
            res["data"][0]["pyg"] != null &&
            res["data"][0]["pyg_12"] != null
              ? (
                  (100 * (res["data"][0]["pyg"] - res["data"][0]["pyg_12"])) /
                  res["data"][0]["pyg_12"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "rmob",
          value: res["data"][0]["mob"],
          var:
            res["data"][0]["mob_12"] != 0 &&
            res["data"][0]["mob"] != null &&
            res["data"][0]["mob_12"] != null
              ? (
                  (100 * (res["data"][0]["mob"] - res["data"][0]["mob_12"])) /
                  res["data"][0]["mob_12"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "rlte",
          value: res["data"][0]["lte"],
          var:
            res["data"][0]["lte_12"] != 0 &&
            res["data"][0]["lte"] != null &&
            res["data"][0]["lte_12"] != null
              ? (
                  (100 * (res["data"][0]["lte"] - res["data"][0]["lte_12"])) /
                  res["data"][0]["lte_12"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "rprepaid",
          value: res["data"][0]["prep"],
          var:
            res["data"][0]["prep_12"] != 0 &&
            res["data"][0]["prep"] != null &&
            res["data"][0]["prep_12"] != null
              ? (
                  (100 * (res["data"][0]["prep"] - res["data"][0]["prep_12"])) /
                  res["data"][0]["prep_12"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "rpostpaid",
          value: res["data"][0]["post"],
          var:
            res["data"][0]["post_12"] != 0 &&
            res["data"][0]["post"] != null &&
            res["data"][0]["post_12"] != null
              ? (
                  (100 * (res["data"][0]["post"] - res["data"][0]["post_12"])) /
                  res["data"][0]["post_12"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "rtot",
          value: res["data"][0]["tot"],
          var:
            res["data"][0]["tot_12"] != 0 &&
            res["data"][0]["tot"] != null &&
            res["data"][0]["tot_12"] != null
              ? (
                  (100 * (res["data"][0]["tot"] - res["data"][0]["tot_12"])) /
                  res["data"][0]["tot_12"]
                ).toFixed(2)
              : 100,
        });
      ...
      case "vue1":
        ...
        return $.when(
          $.ajax({
            ...
            // data.data = res.data
            data.data = getTreeHierachy(res.data, ["type", "grp"], "type", [
              "kpi",
            ]);
          })
        ).then(function () {
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.kpi > 0)
                dat[elm.bndle_type] =
                  typeof dat[elm.bndle_type] == "undefined"
                    ? [{ name: elm.bndle_group, value: elm.kpi }]
                    : [
                        ...dat[elm.bndle_type],
                        { name: elm.bndle_group, value: elm.kpi },
                      ];
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.sms > 0)
                data["data"].push({
                  /*commune : elm.commune,  district : elm.district,*/ region:
                    elm.region,
                  zoneorange: elm.region,
                  value: elm.sms,
                  _type: "sms_split",
                });
              if (elm.voice > 0)
    ...
    return $.when(
      $.ajax({
        ...
        data["data"].push({
          ...
          value: k2,
          var:
            k1 != 0 && k1 != null ? ((100 * (k2 - k1)) / k1).toFixed(2) : 100,
        });
            ...
            return $.when(
              $.ajax({
                ...
                res.data.forEach((elm) => {
                  if (elm.voice > 0)
                    data["data"].push({
                      /*commune : elm.commune,  district : elm.district,*/ zoneorange:
                        elm.region,
                      value: elm.voice,
                      _type: "voice_split",
                    });
          ...
          case "voice":
            return $.when(
              $.ajax({
                ...
                res.data.forEach((elm) => {
                  if (elm.voice_traff > 0)
                    data["data"].push({
                      code: elm.code,
                      country: elm.country,
                      value: Number.parseFloat(elm.voice_traff),
                      _type: "voice_geo_split",
                    });
                });
              })
            ).then(function () {
                ...
                res.data.forEach((elm) => {
                  if (elm.sms_traff > 0)
                    data["data"].push({
                      code: elm.code,
                      country: elm.country,
                      value: Number.parseFloat(elm.sms_traff),
                      _type: "sms_geo_split",
                    });
                });
              })
          ...
          case "all":
            return $.when(
              $.ajax({
                ...
                let smsdata = res.data.map((d) => {
                  return { country: d.country, value: d.sms_traff };
                });
                let voicedata = res.data.map((d) => {
                  return { country: d.country, value: d.voice_traff };
                });
          ...
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.voice_pyg > 0)
                data["data"].push({
                  traff_type: "voice",
                  traffic: Number.parseFloat(elm.voice_pyg),
                  _type: "month_trend",
                  month: elm.month,
                  free: "pyg",
                });
              if (elm.sms_pyg > 0)
                data["data"].push({
                  traff_type: "sms",
                  traffic: Number.parseFloat(elm.sms_pyg),
                  _type: "month_trend",
                  month: elm.month,
                  free: "pyg",
                });
              if (elm.data_pyg > 0)
                data["data"].push({
                  traff_type: "data",
                  traffic: Number.parseFloat(elm.data_pyg),
                  _type: "month_trend",
                  month: elm.month,
                  free: "pyg",
                });
              ...
              if (elm.voice_free > 0)
                data["data"].push({
                  traff_type: "voice",
                  traffic: Number.parseFloat(elm.voice_free),
                  _type: "month_trend",
                  month: elm.month,
                  free: "bundle",
                });
              if (elm.sms_free > 0)
                data["data"].push({
                  traff_type: "sms",
                  traffic: Number.parseFloat(elm.sms_free),
                  _type: "month_trend",
                  month: elm.month,
                  free: "bundle",
                });
              if (elm.data_free > 0)
                data["data"].push({
                  traff_type: "data",
                  traffic: Number.parseFloat(elm.data_free),
                  _type: "month_trend",
                  month: elm.month,
                  free: "bundle",
                });
          ...
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.voice_in > 0)
                data["data"].push({
                  traff_type: "voice",
                  traffic: Number.parseFloat(elm.voice_in),
                  _type: "dt_trend",
                  upd_dt: elm.upd_dt,
                  traff_dir: "in",
                  traff_cat: elm.type,
              ...
              if (elm.voice_out > 0)
                data["data"].push({
                  traff_type: "voice",
                  traffic: Number.parseFloat(elm.voice_out),
                  _type: "dt_trend",
                  upd_dt: elm.upd_dt,
                  traff_dir: "out",
                  traff_cat: elm.type,
              ...
              if (elm.sms_in > 0)
                data["data"].push({
                  traff_type: "sms",
                  traffic: Number.parseFloat(elm.sms_in),
                  _type: "dt_trend",
                  upd_dt: elm.upd_dt,
                  traff_dir: "in",
                  traff_cat: elm.type,
              ...
              if (elm.sms_out > 0)
                data["data"].push({
                  traff_type: "sms",
                  traffic: Number.parseFloat(elm.sms_out),
                  _type: "dt_trend",
                  upd_dt: elm.upd_dt,
                  traff_dir: "out",
                  traff_cat: elm.type,
            ...
            res.data.forEach((elm) => {
              if (elm.voice_traff > 0)
                data.data.push({
                  _type: "voice",
                  offer: elm.offer,
                  produit: elm.offer_group,
                  bill_tpe: elm.billing_type,
                  value: elm.voice_traff,
                });
              if (elm.sms_traff > 0)
                data.data.push({
                  _type: "sms",
            ...
            res.data.forEach((elm) => {
              if (elm.voice_in > 0)
                data["data"].push({
                  ...
                  traff_dir: "in",
                  tot:
                    Number.parseFloat(elm.voice_in) +
                    Number.parseFloat(elm.voice_out),
                });
              if (elm.voice_out > 0)
                data["data"].push({
                  traff_type: "voice",
              ...
              if (elm.sms_in > 0)
                data["data"].push({
                  ...
                  traff_dir: "in",
                  tot:
                    Number.parseFloat(elm.sms_in) +
                    Number.parseFloat(elm.sms_out),
                });
              if (elm.sms_out > 0)
                data["data"].push({
                  traff_type: "sms",
          ...
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.data_in > 0)
                data["data"].push({
                  traff_type: "data",
                  traffic: Number.parseFloat(elm.data_in),
                  _type: "dt_trend",
                  upd_dt: elm.upd_dt,
                  traff_dir: "in",
                  traff_cat: elm.type,
              ...
              if (elm.data_out > 0)
                data["data"].push({
                  traff_type: "data",
                  traffic: Number.parseFloat(elm.data_out),
                  _type: "dt_trend",
                  upd_dt: elm.upd_dt,
                  traff_dir: "out",
                  traff_cat: elm.type,
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.kpi_amnt > 0)
                data["data"].push({
                  amnt: Number.parseFloat(elm.kpi_amnt),
                  _type: "month_trend",
                  month: elm.month,
                  rec_type: elm.rec_type,
                });
            });
          })
        ).then(function (dat) {
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.kpi_qty > 0)
                data["data"].push({
                  value: Number.parseFloat(elm.kpi_qty),
                  _type: "month_trend",
                  month: elm.month,
                  ec_type: elm.ec_type,
                  _kpi: "qty",
              ...
              if (elm.kpi_loan > 0)
                data["data"].push({
                  value: Number.parseFloat(elm.kpi_loan),
                  _type: "month_trend",
                  month: elm.month,
                  ec_type: elm.ec_type,
                  _kpi: "loan",
              ...
              if (elm.kpi_fees > 0)
                data["data"].push({
                  value: Number.parseFloat(elm.kpi_fees),
                  _type: "month_trend",
                  month: elm.month,
                  ec_type: elm.ec_type,
                  _kpi: "fees",
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.borrow > 0)
                data["data"].push({
                  value: Number.parseFloat(elm.borrow),
                  _type: "month_trend",
                  month: elm.month,
                  _kpi: "borrow_trend",
                });
              if (elm.reimb > 0)
                data["data"].push({
                  value: Number.parseFloat(elm.reimb),
                  _type: "month_trend",
                  month: elm.month,
                  _kpi: "reimburse_trend",
                });
              if (elm.fs > 0)
                data["data"].push({
                  value: Number.parseFloat(elm.fs),
                  _type: "month_trend",
                  month: elm.month,
                  _kpi: "fees_trend",
                });
              if (elm.borrow > 0)
                data["data"].push({
                  value: Math.abs(
                    100 *
                      (
                        (Number.parseFloat(elm.reimb) -
                          Number.parseFloat(elm.fs)) /
                        Number.parseFloat(elm.borrow)
                      ).toFixed(2)
                  ),
                  _type: "month_trend",
                  month: elm.month,
            ...
            return $.when(
              $.ajax({
                ...
                res.data.forEach((elm) => {
                  if (elm.kpi_val > 0)
                    data["data"].push({
                      trend: Number.parseFloat(elm.kpi_val),
                      _type: "month_trend",
                      month: elm.month,
                    });
                });
            ...
            return $.when(
              $.ajax({
                ...
                res.data.forEach((elm) => {
                  if (elm.kpi_val > 0)
                    data["data"].push({
                      trend_dt: Number.parseFloat(elm.kpi_val),
                      _type: "dt_trend",
                      upd_dt: elm.upd_dt,
                      period: elm.upd_dt.substr(0, 7),
                    });
                  ...
                  if (elm.kpi_val > 0)
                    if (elm.user_type)
                      data["data"].push({
                        trend: Number.parseFloat(elm.kpi_val),
                        _scale: "month_trend",
                        _type: elm.user_type + "_month_trend",
                        month: elm.month,
                      });
                    else
                      data["data"].push({
            ...
            return $.when(
              $.ajax({
                ...
                res.data.forEach((elm) => {
                  if (elm.comm_val > 0)
                    data["data"].push({
                      value: Number.parseFloat(elm.comm_val),
                      _kpi: "comm",
                      _type: "month_trend",
                      trans_type: elm.tpe,
                      month: elm.month,
                  ...
                  if (elm.rev_val > 0)
                    data["data"].push({
                      value: Number.parseFloat(elm.rev_val),
                      _kpi: "rev",
                      _type: "month_trend",
                      trans_type: elm.tpe,
                      month: elm.month,
          ...
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.kpi_val > 0)
                if (elm.user_type)
                  data["data"].push({
                    value: Number.parseFloat(elm.kpi_val),
                    _type: elm.user_type + "_parc_split",
                    trans_type: elm.tpe,
                  });
                else
                  data["data"].push({
                    value: Number.parseFloat(elm.kpi_val),
                    _type: "subs_parc_split",
                    trans_type: elm.tpe,
                  });
            });
          })
    ...
    return $.when(
      $.ajax({
        ...
        res.data.forEach((elm) => {
          ...
          k1 = res["data"][0]["ocb_"]
            ? Number.parseFloat(res["data"][0]["ocb_"])
            : 0;
          k2 = res["data"][0]["ocb"]
            ? Number.parseFloat(res["data"][0]["ocb"])
            : 0;
          data["data"].push({
            kpi: "ocb",
            value: k2,
      ...
      $.ajax({
        ...
        res.data.forEach((elm) => {
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_nb_profile"]
                ? ((100 * res["data"][0]["var_nb_profile"]) / k1).toFixed(2)
                : 100,
            _type: "nb_profile",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_nb_actif"]
                ? ((100 * res["data"][0]["var_nb_actif"]) / k1).toFixed(2)
                : 100,
            _type: "nb_actif",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_nb_susp"]
                ? ((100 * res["data"][0]["var_nb_susp"]) / k1).toFixed(2)
                : 100,
            _type: "nb_susp",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_nb_rsl"] != null
                ? ((100 * res["data"][0]["var_nb_rsl"]) / k1).toFixed(2)
                : 100,
            _type: "nb_rsl",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_nb_total"] != null
                ? ((100 * res["data"][0]["var_nb_total"]) / k1).toFixed(2)
                : 100,
            _type: "nb_total",
          });
        });
      ...
      $.ajax({
        ...
        res.data.forEach((elm) => {
          data.data.push({
            profile: elm.service,
            trend: elm.actif,
            _type: "month_trend_act",
            month: elm.month,
          });
          data.data.push({
            profile: elm.service,
            trend: elm.susp,
            _type: "month_trend_susp",
            month: elm.month,
          });
        });
      })
      ...
      $.ajax({
        ...
        res.data.forEach((elm) => {
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_tqty"]
                ? ((100 * res["data"][0]["var_tqty"]) / k1).toFixed(2)
                : 100,
            _type: "tqty",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_tamnt"]
                ? ((100 * res["data"][0]["var_tamnt"]) / k1).toFixed(2)
                : 100,
            _type: "tamnt",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_div_qty"]
                ? ((100 * res["data"][0]["var_div_qty"]) / k1).toFixed(2)
                : 100,
            _type: "div_qty",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_div_amnt"] != null
                ? ((100 * res["data"][0]["var_div_amnt"]) / k1).toFixed(2)
                : 100,
            _type: "div_amnt",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_gsm_qty"] != null
                ? ((100 * res["data"][0]["var_gsm_qty"]) / k1).toFixed(2)
                : 100,
            _type: "gsm_qty",
          });
          ...
          data["data"].push({
            ...
            value: k1,
            var:
              k1 != 0 && k1 != null && res["data"][0]["var_gsm_amnt"] != null
                ? ((100 * res["data"][0]["var_gsm_amnt"]) / k1).toFixed(2)
                : 100,
            _type: "gsm_amnt",
          });
        });
            ...
            return $.when(
              $.ajax({
                ...
                res.data.forEach((elm) => {
                  if (elm.kpi_amnt > 0)
                    data["data"].push({
                      trend: Number.parseFloat(elm.kpi_amnt),
                      _type: "month_trend",
                      month: elm.month,
                      product: elm.product,
                    });
      ...
      case "vue1":
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              dat[elm.product] =
                typeof dat[elm.product] == "undefined"
                  ? [elm]
                  : [...dat[elm.product], elm];
            });
          })
          ...
          for (const prod in dat) {
            ...
            const items = element.map(function (d) {
              return { name: d.item, value: d.amnt, tot: prods };
            });
            data["data"].push({
              name: prod,
              value: prods,
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              if (elm.kpi_amnt > 0)
                data["data"].push({
                  trend_dt: Number.parseFloat(elm.kpi_amnt),
                  _type: "dt_trend",
                  upd_dt: elm.upd_dt,
                  period: elm.upd_dt.substr(0, 7),
                });
    ...
    return $.when(
      $.ajax({
        ...
        data["data"].push({
          ...
          var:
            res["data"][0]["rv_"] != 0 &&
            res["data"][0]["rsales"] != null &&
            res["data"][0]["rv_"] != null
              ? (
                  (100 * (res["data"][0]["rsales"] - res["data"][0]["rv_"])) /
                  res["data"][0]["rv_"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "rv_post",
          value: res["data"][0]["rv_post"],
          var:
            res["data"][0]["rv_post_"] != 0 &&
            res["data"][0]["rv_post"] != null &&
            res["data"][0]["rv_post_"] != null
              ? (
                  (100 *
                    (res["data"][0]["rv_post"] - res["data"][0]["rv_post_"])) /
                  res["data"][0]["rv_post_"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "rv_pre",
          value: res["data"][0]["rv_pre"],
          var:
            res["data"][0]["rv_pre_"] != 0 &&
            res["data"][0]["rv_pre"] != null &&
            res["data"][0]["rv_pre_"] != null
              ? (
                  (100 *
                    (res["data"][0]["rv_pre"] - res["data"][0]["rv_pre_"])) /
                  res["data"][0]["rv_pre_"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "qte",
          value: res["data"][0]["qte"],
          var:
            res["data"][0]["qte_"] != 0 &&
            res["data"][0]["qte"] != null &&
            res["data"][0]["qte_"] != null
              ? (
                  (100 * (res["data"][0]["qte"] - res["data"][0]["qte_"])) /
                  res["data"][0]["qte_"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "fpaid",
          value: res["data"][0]["fpaid"],
          var:
            res["data"][0]["fpaid_"] != 0 &&
            res["data"][0]["fpaid"] != null &&
            res["data"][0]["fpaid_"] != null
              ? (
                  (100 * (res["data"][0]["fpaid"] - res["data"][0]["fpaid_"])) /
                  res["data"][0]["fpaid_"]
                ).toFixed(2)
              : 100,
        });
        data["data"].push({
          kpi: "qpaid",
          value: res["data"][0]["qpaid"],
          var:
            res["data"][0]["qpaid_"] != 0 &&
            res["data"][0]["qpaid"] != null &&
            res["data"][0]["qpaid_"] != null
              ? (
                  (100 * (res["data"][0]["qpaid"] - res["data"][0]["qpaid_"])) /
                  res["data"][0]["qpaid_"]
                ).toFixed(2)
              : 100,
        });
          ...
          case "bill_mark":
            ...
            return $.when(
              $.ajax({
                ...
                data.data = getHierachy(
                  res.data,
                  ["billing_type", "market", "offer_group"],
                  "revenue"
                );
              })
            ).then(function () {
        ...
        return $.when(
          $.ajax({
            ...
            res.data.forEach((elm) => {
              ...
              data.data.push({
                name: elm.month,
                value: Number.parseInt(elm.rev_fact),
                _kpi: "bill_trend",
                _type: "month_trend",
              });
              data.data.push({
                name: elm.month,
                value: Number.parseInt(elm.rev_paid),
                _kpi: "paid_trend",
                _type: "month_trend",
              });
              data.data.push({
