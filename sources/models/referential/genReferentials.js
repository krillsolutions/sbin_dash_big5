...
export const filter_ref = new Promise((res,rej) => {
		...
		//console.log(opt_ref);
    		for(let ref of filters) {
        		...
        		value['filters'][ref.name] = { default : ref.default, desc : ref.description, icon : ref.icon, illustration : ref.illustration, options : [...opt_ref[ref.name]]   };
    		}
		//	console.log(value);		
			res(value);
		})
...
export const components = {
	...
	'home' : [], 'revenue' : [], 'traffic' : [], 'parc' : [], 'recharge' : [], 'om' : [], 'monitor' : [], 'wimax' : [], 'sales' : [], 'bills' : []
