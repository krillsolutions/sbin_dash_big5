	...
	config () 
	{
		var rows = [];		
                ...
                var rowstat = {
                        ...
                        cells : [
                                { view:"panel", x:0, y:0, dx:1, dy:1, body : new TraffStatView(this.app, "",'voice') },
                                { view:"panel", x:1, y:0, dx:1, dy:1, body : new TraffStatView(this.app, "", 'sms') },
                                { view:"panel", x:2, y:0, dx:1, dy:1, body :  new TraffStatView(this.app, "", 'data') },
                                { view:"panel", x:3, y:0, dx:1, dy:1, body : new TraffStatView(this.app, "", 'rpyg') }
                        ]
                };		
	...
	init(view) {
                ...
                webix.event(window, "resize", function(){
                        ...
                        if(getScreenTypeByMenu('traffic') != getScreenType()) {
                                        setScreenTypeByMenu('traffic', getScreenType());
                                        if(gconfig['dashboards']['traffic']._container != null)  gconfig['dashboards']['traffic'].refresh();
                        }				
