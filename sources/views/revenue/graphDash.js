        ...
        
	{
		...
		switch(getScreenType()) {
                        ...
                        case 'mobile' :
                                ...
                                gridRows = 21;
                                cells.push({ 
                                        view:"panel", x:0, y:0, dx:4, dy:5, resize:true,header : new GraphHeadView(this.app, "", "rev_global", "homelines"),
				        body : { type : 'clean', margin : 0, rows : [RevByTypeSplitView,new PeriodSelector(this.app,"","revByType",3), RevByTypeTrendViewNew]},css : { "background-color":"#fff"} 
                                });
                                
                                cells.push({ 
                                        view:"panel", x:0, y:5, dx:4, dy:5, resize:true,header : new GraphHeadView(this.app, "", "rev_by_line", "homelines"),
                                        body : { type : 'clean', margin : 0, 
                                        rows : [RevByLineView,new PeriodSelector(this.app,"","revByLine",2),  RevByLineTrendView]} ,  css : { "background-color":"#fff"}
                                });

                                cells.push({ 
                                        view:"panel", x:0, y:10, dx:4, dy:5, resize:true,header : new GraphHeadView(this.app, "", "rev_by_op", "homelines"),
                                        body : { type : 'clean', margin : 0, 
                                        rows : [RevByOPView, TrVoiceByOPView]} ,  css : { "background-color":"#fff"}
                                });

                                cells.push({ 
                                        view:"panel", x:0, y:15, dx:4, dy:6, resize:true, header : new GraphHeadView(this.app, "", "rev_other", ""), 
                                        body :{ type : 'clean', margin : 0, rows : [RevTypeProdView,RevByCltView]}
                                })
                        ...
                        case 'mobile_rotated' :
                                ...
                                gridRows = 4;
                                cells.push({ 
                                        view:"panel", x:0, y:0, dx:3, dy:2, resize:true,header : new GraphHeadView(this.app, "", "rev_global", "homelines"),
				        body : { type : 'clean', margin : 0, rows : [RevByTypeSplitView,new PeriodSelector(this.app,"","revByType",3), RevByTypeTrendViewNew]},css : { "background-color":"#fff"} 
                                });
                                
                                cells.push({ 
                                        view:"panel", x:3, y:0, dx:3, dy:2, resize:true,header : new GraphHeadView(this.app, "", "rev_by_line", "homelines"),
                                        body : { type : 'clean', margin : 0, 
                                        rows : [RevByLineView,new PeriodSelector(this.app,"","revByLine",2),  RevByLineTrendView]} ,  css : { "background-color":"#fff"}
                                });

                                cells.push({ 
                                        view:"panel", x:0, y:2, dx:3, dy:2, resize:true,header : new GraphHeadView(this.app, "", "rev_by_op", "homelines"),
                                        body : { type : 'clean', margin : 0, 
                                        rows : [RevByOPView, TrVoiceByOPView]} ,  css : { "background-color":"#fff"}
                                });

                                cells.push({ 
                                        view:"panel", x:3, y:2, dx:3, dy:2, resize:true, header : new GraphHeadView(this.app, "", "rev_other", ""), 
                                        body :{ type : 'clean', margin : 0, rows : [RevTypeProdView,RevByCltView]}
                                })  
			...
			cells.push({ view:"panel", x:4, y:0, dx:2, dy:6, resize:true,header : new GraphHeadView(this.app, "", "rev_by_op", "homelines"),
                        body : { type : 'clean', margin : 0, 
                rows : [RevByOPView, TrVoiceByOPView]} ,  css : { "background-color":"#fff"}});


                        cells.push({ view:"panel", x:6, y:0, dx:2, dy:6, resize:true, header : new GraphHeadView(this.app, "", "rev_other", ""), body :{ type : 'clean', margin : 0, rows : [RevTypeProdView,RevByCltView]}
