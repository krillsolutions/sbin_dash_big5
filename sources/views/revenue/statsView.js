...
export default class StatsView extends JetView{
	...
	config () 
	{
		...
		var rowstat = {
			...
			cells : [
                                { view:"panel", x:0, y:0, dx:1, dy:1, body : new RevStatView(this.app, "", 'rtot') },
                                { view:"panel", x:1, y:0, dx:1, dy:1, body : new RevStatView(this.app, "", 'rpyg') },
                                { view:"panel", x:2, y:0, dx:1, dy:1, body :  new RevStatView(this.app, "", 'rmob') },
								{ view:"panel", x:5, y:0, dx:1, dy:1, body : new RevStatView(this.app, "", 'rlte') },
                                { view:"panel", x:3, y:0, dx:1, dy:1, body : new RevStatView(this.app, "", 'rprepaid') },
                                { view:"panel", x:4, y:0, dx:1, dy:1, body : new RevStatView(this.app, "", 'rpostpaid') },
	...
	init(view) {
		...
		webix.event(window, "resize", function(){
			if( typeof $$('top:menu') == 'undefined' ||  $$('top:menu').getSelectedId() == 'revenue') {
