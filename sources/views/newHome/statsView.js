	...
	config () 
	{
		...
		var rowstat = {
			...
			cells : [
				...
				{ view:"panel", x:1, y:0, dx:1, dy:1, body : new HomeStatView(this.app, "", 'revenue')},
				{ view:"panel", x:2, y:0, dx:1, dy:1, body :  new HomeStatView(this.app, "", 'tvoix')},
				{ view:"panel", x:3, y:0, dx:1, dy:1, body : new HomeStatView(this.app, "", 'tdata') },
				{ view:"panel", x:4, y:0, dx:1, dy:1, body : new HomeStatView(this.app, "", 'topup') },
				{ view:"panel", x:5, y:0, dx:1, dy:1, body : new HomeStatView(this.app, "", 'encaiss')},
			]
		};
	 return rowstat
