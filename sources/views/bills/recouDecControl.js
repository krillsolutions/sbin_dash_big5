...
export default class RecouvCarControl extends JetView {
    ...
    config(){
        ...
        return {
            view : "select", id : "recouv:control:"+this._fact,
            label:"Produit", labelAlign:'right', inputWidth : 200, align : 'left', inputHeight : 25,css : {'font-size': '12px'},
            options :[], height : 30
        }
    ...
    init(view){
        ...
        filter_ref.then((filter_ref) => {
            view.define("options",filter_ref["filters"]["p"]["options"] )
        })
        ...
        view.define('on', 
        {
            'onChange' : (n,o)=> {
                ...
                if($$("recouvr:vue2:decay:"+this._fact)) {
                    ...
                    $$("recouvr:vue2:decay:"+this._fact).filter(d => (d.product == n && d.type == fact))
                }
