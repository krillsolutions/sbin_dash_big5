...
export default class TraficByTypeGraphDashView extends JetView{
        ...
        
	{
        ...
        const kpi = this._kpi, data = this._data;
		var gridColumns,
			gridRows,
			 cells = [];
                var config = {
               ...
               /*                 case 'mobile' :
				...
				break;*/
                                ...
                                case 'mobile' :
                                        ...
                                        cells.push({ 
                                                view:"panel", x:0, y:0, dx:4, dy:2, resize:true,header : new GraphHeadView(this.app, "", "traffic_offer_"+kpi, kpi),
                                        ...
                                        cells.push({ 
                                                view:"panel", x:0, y:2, dx:4, dy:2, resize:true,header : new GraphHeadView(this.app, "", "traffic_geo_int_"+kpi, kpi),
                                                body : {type : 'clean', margin : 0, rows : [ new TraffIntView(this.app, "",kpi), new TraffIntGeoView(this.app, "", kpi) ],
                                                },css : { "background-color":"#fff"}
                                        });
                        
                                        cells.push({ 
                                                view:"panel", x:0, y:4, dx:4, dy:2, resize:true, header : new GraphHeadView(this.app, "", "traffic_other_"+kpi, kpi),
                                                body : {type : 'clean', margin : 0, rows :[ new TraffByDestView(this.app, "", kpi), new TraffByOPView(this.app, "",kpi)] },css :{ "background-color":"#fff"}
                                        }) 
                                ...
                                case 'mobile_rotated' :
                                        ...
                                        cells.push({ 
                                                view:"panel", x:0, y:0, dx:2, dy:2, resize:true,header : new GraphHeadView(this.app, "", "traffic_offer_"+kpi, kpi),
                                                body : {type : 'clean', margin : 0, rows : [new TraffByOfferView(this.app, "", kpi), new PeriodSelector(this.app,"","traffByType_"+kpi,3), new TraffByTypeTrendView(this.app, "", kpi)]}, 
                                                css : { "background-color":"#fff"}
                                        });

                                        cells.push({ 
                                                view:"panel", x:2, y:0, dx:2, dy:2, resize:true, header : new GraphHeadView(this.app, "", "traffic_other_"+kpi, kpi),
                                                body : {type : 'clean', margin : 0, rows :[ new TraffByDestView(this.app, "", kpi), new TraffByOPView(this.app, "",kpi)] },css :{ "background-color":"#fff"}
                                        })

                                        cells.push({ 
                                                view:"panel", x:0, y:2, dx:4, dy:2, resize:true,header : new GraphHeadView(this.app, "", "traffic_geo_int_"+kpi, kpi),
                                                body : {type : 'clean', margin : 0, cols : [ new TraffIntView(this.app, "",kpi), new TraffIntGeoView(this.app, "", kpi) ],
                                                },css : { "background-color":"#fff"}
                                        });
			...
			gridColumns = 9;
			gridRows = 3;			
				cells.push({ view:"panel", x:0, y:0, dx:3, dy:3, resize:true,header : new GraphHeadView(this.app, "", "traffic_offer_"+kpi, kpi),
                                                body : {type : 'clean', margin : 0, rows : [new TraffByOfferView(this.app, "", kpi), new PeriodSelector(this.app,"","traffByType_"+kpi,3), new TraffByTypeTrendView(this.app, "", kpi)]}, 
                                                 css : { "background-color":"#fff"}});

				cells.push({ view:"panel", x:3, y:0, dx:3, dy:3, resize:true,header : new GraphHeadView(this.app, "", "traffic_geo_int_"+kpi, kpi),
                                                body : {type : 'clean', margin : 0, rows : [ new TraffIntView(this.app, "",kpi), new TraffIntGeoView(this.app, "", kpi) ],
                                                },css : { "background-color":"#fff"}});
				
				cells.push({ view:"panel", x:6, y:0, dx:3, dy:3, resize:true, header : new GraphHeadView(this.app, "", "traffic_other_"+kpi, kpi),
                                            body : {type : 'clean', margin : 0, rows :[ new TraffByDestView(this.app, "", kpi), new TraffByOPView(this.app, "",kpi)] },css :{ "background-color":"#fff"}})
