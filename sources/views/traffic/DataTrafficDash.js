    ...
    switch (getScreenType()) {
      ...
      case "mobile":
        ...
        cells.push({
          ...
          dy: 2,
          resize: true,
          header: new GraphHeadView(this.app, "", "traffic_offer_data"),
          body: {
            type: "clean",
            margin: 0,
            rows: [
        ...
        cells.push({
          ...
          dy: 2,
          resize: true,
          header: new GraphHeadView(this.app, "", "traffic_other_data"),
          body: {
            type: "clean",
            margin: 0,
            rows: [
              new PeriodSelector(this.app, "", "traffByType_dest_" + kpi, 2, 1),
              TraffDataByDestView,
              DataSplitTypetSplitView,
            ],
          },
          css: { "background-color": "#fff" },
        });
        ...
        cells.push({
          ...
          dy: 2,
          resize: true,
          header: new GraphHeadView(this.app, "", "data_repartition"),
          body: {
            type: "clean",
            margin: 0,
            rows: [DataParcView, TraffDataSiteView],
          },
          css: { "background-color": "#fff" },
        });
      ...
      case "mobile_rotated":
        ...
        cells.push({
          ...
          body: {
            type: "clean",
            margin: 0,
            cols: [DataParcView, TraffDataSiteView],
          },
          css: { "background-color": "#fff" },
        });
