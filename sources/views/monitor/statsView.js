...
import { getStats } from "views/monitor/config/utils";
...
export default class StatsView extends JetView {
  config() {
    ...
    var rowstat = {
      ...
      //   dx: 1,
      //   dy: 1,
      //   body: new MonStatView(this.app, "", "tot"),
      // },
      // {
      //   view: "panel",
      //   x: 1,
      ...
      //   dx: 1,
      //   dy: 1,
      //   body: new MonStatView(this.app, "", "ocs"),
      // },
      // {
      //   view: "panel",
      //   x: 2,
      ...
      //   dx: 1,
      //   dy: 1,
      //   body: new MonStatView(this.app, "", "ims"),
      // },
      // {
      //   view: "panel",
      //   x: 3,
      ...
      //   dx: 1,
      //   dy: 1,
      //   body: new MonStatView(this.app, "", "ocb"),
      // },
      // {
      //   view: "panel",
      //   x: 4,
      ...
      //   dx: 1,
      //   dy: 1,
      //   body: new MonStatView(this.app, "", "pgw"),
      // },
      // {
      //   view: "panel",
      //   x: 5,
      ...
      //   dx: 1,
      //   dy: 1,
      //   body: new MonStatView(this.app, "", "msc"),
      // },
      // {
      //   view: "panel",
      //   x: 6,
      ...
      //   dx: 1,
      //   dy: 1,
      //   body: new MonStatView(this.app, "", "sico"),
      // },
      //   ],
    };
    return rowstat;
  ...
  init(view) {
    ...
    webix.event(window, "resize", function () {
      if (
        ...
        $$("top:menu").getSelectedId() == "monitor"
      ) {
