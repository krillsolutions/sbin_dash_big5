...
//            minHeight : 115,
        ...
        init(view) {
                ...
                $$("home:vue1:trend:topup").showProgress();
                $$("home:vue1:trend:topup").disable();
                components['home'].push({cmp : "home:vue1:trend:topup", data : getHomeChartData('trend_topup').config.id});
                ...
                getHomeChartData('trend_topup').waitData.then((d) => {
			$$("home:vue1:trend:topup")._isDataLoaded = 1;
                        $$("home:vue1:trend:topup").parse(getHomeChartData('trend_topup'));
                        $$("home:vue1:trend:topup").enable();
                        $$("home:vue1:trend:topup").hideProgress();
                ...
                $$("home:vue1:trend:topup").data.attachEvent("onBeforeLoad", function () {
