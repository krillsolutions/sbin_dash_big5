    ...
    static loadData() {
        ...
        components[menu].forEach(element => {
            ...
            if(typeof $$(element.data) != 'undefined') 
                $$(element.data).callEvent('onFilterData', [menu, $$(element.data)._func, $$(element.data)._param, ($$(element.data)._params)?$$(element.data)._params:""]);
            ...
            element.forEach(elm => {
                if(typeof $$(elm.data) != 'undefined')  {
                    ...
                    if(!dat.some((d) => d == elm.data)) {
                        $$(elm.data).callEvent('onFilterData', [$$(elm.data)._menu, $$(elm.data)._func, $$(elm.data)._param, ($$(elm.data)._params)?$$(elm.data)._params:""]);
                        dat.push(elm.data);
                    }
                }
            });
